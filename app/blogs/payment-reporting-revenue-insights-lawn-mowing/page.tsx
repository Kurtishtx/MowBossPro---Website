...
export const metadata = {
  title: 'Payment Reporting and Revenue Insights for Lawn Mowing Owners | MowBossPro',
  description: 'See how MowBossPro turns every mowing payment into clear revenue reports so owners know what they earned, who owes, and where to grow.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <p>
          Because the software ties payments to jobs and not just to dates, your revenue reports stay honest. You are not guessing whether a $45 deposit was the Johnson cut or the corner duplex &mdash; the system already knows.
        </p>

        <h2>Revenue Reports That Answer Real Questions</h2>
        <p>
