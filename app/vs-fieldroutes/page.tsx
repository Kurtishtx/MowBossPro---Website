  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>FieldRoutes Won&apos;t Tell You What It Costs Until You&apos;ve Sat Through a Demo.<br /><span>MowBossPro Is $59. Start Today.</span></h1>
        <p>FieldRoutes requires a demo before you can even see pricing. Then an implementation timeline before you can use the software. MowBossPro is from $59/month, published right here, with a 14-day free trial you can start in the next 5 minutes — no sales call, no demo, no waiting.</p>
        ...
        <div className="hero-stats">
          <div><div className="hero-stat-val">$59</div><div className="hero-stat-lbl">MowBossPro — Published Price</div></div>
        ...
        <div style={{maxWidth:'1100px', margin:'0 auto'}}>
          <div className="highlight-row">
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>FieldRoutes hides their pricing behind a required demo. That means a sales presentation, a callback from a rep, a negotiation, and an implementation timeline before you can run a single route. MowBossPro costs from $59/month. You can see it. You can start it. Right now.</p>
      ...
      <section>
        ...
        <div className="simple-grid">
          ...
          <div className="simple-card"><div className="simple-num">02</div><h3>$59. Always. No Custom Quotes.</h3><p>FieldRoutes pricing varies based on your operation size — you negotiate it during the sales process. MowBossPro is from $59/month. There&apos;s no call to make, no rep to wait for, no pricing package to compare. Just $59.</p></div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">$59/Month. Published. No Demo Required.</h2>
          <p className="section-sub">FieldRoutes won&apos;t tell you their price until you talk to sales. MowBossPro is $59. Start today.</p>
        </div>
      ...
      <div className="cta-band">
        <h2>Done Waiting for a Sales Rep to Tell You What Software Costs?<span>MowBossPro Is $59. Start Right Now.</span></h2>
