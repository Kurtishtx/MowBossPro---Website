    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .highlight-visual-dark { flex: 1; min-width: 280px; background: linear-gradient(135deg, var(--purple-deep) 0%, #0a3161 100%); border-radius: 14px; padding: 36px 32px; border: 2px solid rgba(178,34,52,.3); }
      ...
      <div className="hero">
        ...
        <h1>FieldRoutes Won&apos;t Tell You What It Costs Until You&apos;ve Sat Through a Demo.<br /><span>MowBossPro Is $79. Start Today.</span></h1>
        <p>FieldRoutes requires a demo before you can even see pricing. Then an implementation timeline before you can use the software. MowBossPro is $79/month, published right here, with a 14-day free trial you can start in the next 5 minutes — no sales call, no demo, no waiting.</p>
        ...
        <div className="hero-stats">
          <div><div className="hero-stat-val">$79</div><div className="hero-stat-lbl">MowBossPro — Published Price</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">MowBossPro vs FieldRoutes</h2>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>FieldRoutes Has Route Optimization.<br />MowBossPro Has Lasso.</h2>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              <div className="steps-visual">
                ...
                <div className="step-row">
                  <div className="step-row-title">MowBossPro</div>
                  <div className="step-item">
                    <div className="step-num orange">1</div>
                    <div className="step-body"><div className="step-label">Sign Up Online</div><div className="step-sub">$79/mo — price is right here, right now</div><div className="step-badge green">5 minutes</div></div>
                  </div>
                  <div className="step-item">
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>FieldRoutes hides their pricing behind a required demo. That means a sales presentation, a callback from a rep, a negotiation, and an implementation timeline before you can run a single route. MowBossPro costs $79/month. You can see it. You can start it. Right now.</p>
              <ul className="check-list">
                <li>Published pricing — $79/month, no negotiation</li>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">$79/Month. Published. No Demo Required.</h2>
          <p className="section-sub">FieldRoutes won&apos;t tell you their price until you talk to sales. MowBossPro is $79. Start today.</p>
        </div>
      ...
      <div className="cta-band">
        <h2>Done Waiting for a Sales Rep to Tell You What Software Costs?<span>MowBossPro Is $79. Start Right Now.</span></h2>
        <p>Try MowBossPro free for 14 days. No credit card required. No demo required.</p>
        <div className="hero-btns">
