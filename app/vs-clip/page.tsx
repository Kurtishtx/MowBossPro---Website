    ...
    <>
      ...
      <div className="hero">
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">Unlimited</div><div className="hero-stat-lbl">MowBossPro Properties</div></div>
          <div><div className="hero-stat-val">$20/mo</div><div className="hero-stat-lbl">CLIP Extra User Fee</div></div>
          <div><div className="hero-stat-val">$0</div><div className="hero-stat-lbl">MowBossPro Extra User Fee</div></div>
        </div>
      </div>
