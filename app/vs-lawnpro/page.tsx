    ...
    <>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">LawnPro Grow and MowBossPro Are Both $79/Month. Here&apos;s What You Actually Get.</h2>
          <p className="section-sub" style={{maxWidth:'760px', marginLeft:'auto', marginRight:'auto'}}>LawnPro has four plan tiers starting at $0. The $79 Grow plan sounds like a deal — until you see the 7-employee cap, no SMS, and no card-on-file payments. Moving to Plus costs $249/month. MowBossPro is $79 with no caps and no upgrade walls.</p>
        </div>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              <div className="lp-tiers">
                ...
                <div className="lp-tier same-price"><div className="lp-tier-header"><div className="lp-tier-name">LawnPro Grow <span className="same-price-badge">Same Price</span></div><div className="lp-tier-cap">7 employees cap · No SMS · No auto-charge</div></div><div className="lp-tier-price">$79/mo</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">To Get SMS and Card-on-File at LawnPro, You Pay $249/Month. MowBossPro Includes Both at $79.</h2>
          <p className="section-sub" style={{maxWidth:'720px', marginLeft:'auto', marginRight:'auto'}}>LawnPro locks several critical features behind the $249 Plus plan. On top of that, you&apos;re still capped at 15 employees. MowBossPro includes all of these at $79 with no caps.</p>
        </div>
        <div style={{maxWidth:'1100px', margin:'0 auto'}}>
          <div className="highlight-row reverse">
            ...
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-always">
                <div className="sbp-always-label">MowBossPro at $79 — Always Included</div>
          ...
          <table className="compare-table">
            <thead>
              <tr>
                ...
                <th className="sbp-col" style={{width:'22%'}}>MowBossPro $79</th>
                <th style={{width:'22%'}}>LawnPro Grow $79</th>
                <th style={{width:'22%'}}>LawnPro Plus $249</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="feature-name">Monthly Price</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800}}>$79</td><td>$79</td><td>$249</td></tr>
      ...
      <div className="cta-band">
        ...
        <p>MowBossPro is $79/month — the same as LawnPro Grow with unlimited users, SMS, and payments included. Start your free trial today.</p>
        <div className="hero-btns">
