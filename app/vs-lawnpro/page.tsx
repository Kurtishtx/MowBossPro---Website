    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sbp-contrast { background: linear-gradient(135deg, var(--purple-deep) 0%, #0a3161 100%); border-radius: 10px; padding: 16px 18px; border: 2px solid rgba(178,34,52,.3); }
        ...
        .sbp-always { background: linear-gradient(135deg, var(--purple-deep) 0%, #0a3161 100%); border: 2px solid rgba(178,34,52,.3); border-radius: 10px; padding: 16px 18px; }
      ...
      <div className="hero">
        ...
        <h1>LawnPro Grow Is $59/Month — With a 7-Employee Cap, No SMS, and No Card-on-File Payments.<br /><span>MowBossPro Is $59 With Unlimited Users, SMS, and Payments Included.</span></h1>
        <p>LawnPro Grow matches MowBossPro&apos;s price but caps you at 7 employees, locks two-way SMS behind the $249 Plus plan, and doesn&apos;t include card-on-file auto-charge. MowBossPro is the same $59 — with no caps, no locked features, and everything mowing businesses actually need included.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">Unlimited</div><div className="hero-stat-lbl">MowBossPro Users — Always</div></div>
          <div><div className="hero-stat-val">$249</div><div className="hero-stat-lbl">LawnPro Plus for SMS &amp; Payments</div></div>
          <div><div className="hero-stat-val">$59</div><div className="hero-stat-lbl">MowBossPro — Everything Included</div></div>
        </div>
      </div>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-contrast">
                <div className="sbp-contrast-label">MowBossPro at $59 — What You Actually Get</div>
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>LawnPro Grow costs from $59/month — the same as MowBossPro. But it caps your team at 7 employees, locks two-way text messaging behind the $249 Plus plan, and doesn&apos;t include card-on-file auto-charge at any price below Plus.</p>
              <p>MowBossPro is from $59/month with unlimited users, SMS, card-on-file payments, lasso routing, sq ft job board, and service compliance logs — all included. No tier upgrades required.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">To Get SMS and Card-on-File at LawnPro, You Pay $249/Month. MowBossPro Includes Both at $59.</h2>
          <p className="section-sub" style={{maxWidth:'720px', marginLeft:'auto', marginRight:'auto'}}>LawnPro locks several critical features behind the $249 Plus plan. On top of that, you&apos;re still capped at 15 employees. MowBossPro includes all of these at $59 with no caps.</p>
        </div>
        <div style={{maxWidth:'1100px', margin:'0 auto'}}>
          <div className="highlight-row reverse">
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>At LawnPro, you start at from $59/month and realize the features your mowing business needs are Plus-only. You&apos;re pushed to $249/month — nearly double. At MowBossPro, $59 is the only plan because one plan is all you need.</p>
              <ul className="check-list">
            ...
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-always">
                <div className="sbp-always-label">MowBossPro at $59 — Always Included</div>
          ...
          <table className="compare-table">
            <thead>
              <tr>
                ...
                <th className="sbp-col" style={{width:'22%'}}>MowBossPro $59</th>
      ...
      <section>
        ...
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Same Price — More Included</h3><p>LawnPro Grow is from $59/month with a 7-employee cap, no SMS, and no card-on-file payments. MowBossPro is from $59/month with unlimited users, full SMS, card-on-file auto-charge, lasso routing, sq ft job board, and service photos — all included from day one.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>No Employee Caps — Ever</h3><p>As your mowing business grows, you add trucks and crews. LawnPro charges $249/month to get to 15 employees, and you&apos;re still capped. MowBossPro never limits your team size — unlimited employees are included in the base $59 price, no upgrade required.</p></div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">from $59/month. Unlimited users. Everything included. No Plus plan required.</p>
        </div>
      ...
      <div className="cta-band">
        ...
        <p>MowBossPro is from $59/month — the same as LawnPro Grow with unlimited users, SMS, and payments included. Start your free trial today.</p>
        <div className="hero-btns">
