...
export default function MowingBusinessSoftware() {
  useEffect(() => {
    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="MowBossPro mowing business software dashboard on laptop showing the route builder and recurring visit board, with mobile app on phone"
      ...
      <div className="premium-band">
        <h2>Affordable Doesn&apos;t Mean Cheap.<br /><span>This Is Enterprise-Level Mowing Software.</span></h2>
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Route Intelligence</h4><p>Live route maps, drag-and-drop stop ordering, and geographic clustering that tightens every mowing route. Build a full day of stops in minutes and stop burning fuel zig-zagging across town between lawns.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔁</div><h4>Recurring Visits</h4><p>Set a property to weekly, bi-weekly, or every-ten-days and MowBossPro keeps it on the schedule forever. Skips, rain delays, and reschedules roll forward automatically so a mow is never quietly missed.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, invoicing, charge after each mow, payment tracking, overdue reports — the full Stripe integration is wired in. Your customers can pay instantly and you can see every dollar collected in one place.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your crews get a mobile-optimized dashboard with their stops for the day. Complete, skip, reschedule, and add notes — all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a mowing route we&apos;ve ever seen. Draw a circle on your service area map and MowBossPro instantly surfaces every property inside that radius that has a mow due — with stop count, visit type, and revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see every lawn inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops and visit frequency by route automatically</li>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across all your crews and trucks simultaneously in one view</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                ...
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Lawns Selected</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#b22234', fontSize:'18px', fontWeight:800}}>3</div>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Weekly · 8 &nbsp;|&nbsp; Bi-Weekly · 6 &nbsp;|&nbsp; One-Time · 5</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. MowBossPro is the exception. Every screen was designed by people who ran mowing routes — not UX designers who&apos;ve never sat in a truck. Your crews will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, recurring visits, and the route map are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day is right there in a single view.'},
            {n:'03', title:'Your Crews Learn It in Minutes', body:'The mobile app your crews use shows them exactly what they need and nothing they don\'t. Their stops for the day, the property info, the job notes, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Generic Software Wasn&apos;t Built for Mowing</h2>
          <p className="section-sub">Mowing is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re running the same hundreds of lawns every single week, across multiple crews and trucks, with a recurring schedule that never stops moving.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own mowing routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to run <strong>400 lawns on a weekly cycle</strong> and need a route to rebuild itself the moment rain pushes a whole day forward.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t handle that. Because they weren&apos;t built by someone who runs a mowing business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and MowBossPro is the software we always wished existed. New to it? Start with <a href="/blogs/set-up-mowing-business-software-in-a-weekend" style={{color:'var(--orange)', fontWeight:600}}>How to Set Up Your Mowing Business Software in a Single Weekend</a>.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Every tool in MowBossPro was built with mowing workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'🔁', title:'Recurring Visit Scheduling', body:'Set a lawn to weekly, bi-weekly, or any custom cycle and MowBossPro keeps it on the calendar automatically. The next visit generates the moment the last one is marked complete — your recurring schedule runs itself.'},
            {icon:'🗺️', title:'Live Route Map', body:'See every scheduled mow pinned on an interactive map. Drag to reorder stops, build tight geographic routes, and cut drive time before your crew ever leaves the yard.'},
            {icon:'🚦', title:'Crew Dispatch Board', body:'Assign stops to crews and trucks, see every crew\'s day at a glance, and rebalance the load with a drag. Know exactly who is mowing where, all morning long, without a single phone call.'},
            {icon:'🌧️', title:'Rain Day Reschedule', body:'When weather kills a day, push the whole route forward in one click. Every recurring visit shifts cleanly and nothing falls off the schedule. No rebuilding the week by hand.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when a mow is scheduled, when your crew is on the way, and when the job is done. Set it once — MowBossPro handles the communication for every single stop.'},
            ...
            {icon:'💳', title:'Card-on-File Payments', body:'Store cards on file via Stripe. Charge after each mow, send invoices, and collect payments without chasing anyone down. Every dollar tracked in one place.'},
            {icon:'📱', title:'Mobile App for Crews', body:'Your crews get a mobile-optimized view of their stops for the day. Mark jobs complete, skip, or reschedule — right from the truck without calling the office.'},
            {icon:'🏠', title:'Property Profiles', body:'Every lawn has its own record — visit frequency, mowing history, gate codes, notes, GPS coordinates, and photos. Everything tied to the address, not just the customer.'},
            ...
            {icon:'🔁', title:'Estimate Follow-Up Sequences', body:'3 automated follow-up texts go out if a client doesn\'t respond to your estimate. Let MowBossPro chase the deal so you don\'t have to.'},
            ...
            {icon:'👥', title:'Client & Lead Management', body:'Manage existing clients and active prospects side by side. Track estimates, mowing history, and notes all tied to each contact — with a full searchable database.'},
            ...
            {icon:'🚛', title:'Truck Management', body:'Create truck profiles, assign vehicles to crews, and track which truck handled each route. Know exactly what\'s rolling out every day.'},
            ...
            {icon:'📊', title:'Dashboard & Reports', body:'Custom stat cards on your dashboard show today\'s revenue, mows completed, lawns served, money owed, and more — all at a glance the moment you log in.'},
            ...
            {icon:'👥', title:'Unlimited Users', body:'Add every crew member, office staff member, and crew lead at no extra cost. No per-seat fees. Unlimited users are included in the flat from $59/month rate.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2>Your Recurring Routes Rebuild Themselves So You Never Miss a Mow</h2>
            ...
            <ul className="check-list">
              ...
              <li>Summary bar: total stops, crews, revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Dispatch Board — Today&apos;s Routes</div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Crew A — North Route</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 lawns scheduled</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Crew B — East Route</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>18 lawns scheduled</div></div>
              <div style={{marginLeft:'auto', background:'#b22234', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Weekly</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#7fb0ff', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Crew C — West Route</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 lawns scheduled</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Bi-Weekly</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Crew A — Cleanup Add-Ons</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>6 lawns scheduled</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>One-Time</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              <div style={{color:'#b22234', fontSize:'16px', fontWeight:700}}>Every crew, every route, one board.</div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Bill Every Mow Automatically and Get Paid Without Chasing</h2>
            <p>Mowing runs on recurring revenue, and MowBossPro is built around it. Every completed mow can invoice on the spot or batch at the end of the cycle, charge the card on file through Stripe, and update your overdue report the second a payment clears.</p>
            <ul className="check-list">
              <li>Invoice automatically when a mow is marked complete</li>
              <li>Batch-bill a whole route or cycle in one click</li>
              <li>Charge cards on file through Stripe instantly</li>
              <li>Track unpaid, partial, paid, and overdue at a glance</li>
              <li>Automated payment reminder texts for late accounts</li>
              <li>Per-visit and flat monthly billing both supported</li>
              <li>Full payment history tied to every property and client</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>842</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Mows Billed</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>134</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Active Lawns</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#b22234', fontSize:'20px', fontWeight:700}}>$48K</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Collected</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#b22234', fontSize:'20px', fontWeight:700}}>$2.3K</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Overdue</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Weekly Mow · J. Smith</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Card on file · Auto-charged</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#b22234', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Bi-Weekly Mow · M. Torres</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Reminder text sent</div></div>
              <div style={{background:'#b22234', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Overdue</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <ul className="price-features">
              ...
              <li>Recurring Visits by Crew &amp; Route</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Mowing Business Software — Common Questions</h2>
          {[
            {q:'Is MowBossPro built for mowing businesses?', a:'Yes. MowBossPro handles the full mowing operation: recurring visit scheduling, map-based route building, crew dispatch, estimate-to-job conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running weekly mowing routes, not general service businesses.'},
            {q:'Can I run multiple crews and routes from one platform?', a:'Yes. MowBossPro supports unlimited crews and trucks from one account, each with its own dispatch board. You can run north, east, and west routes simultaneously, assign stops with a drag, and rebalance the load in real time.'},
            {q:'How does route building work for mowing?', a:'You open the circle-map lasso tool, draw a circle around a geographic area, and every lawn due inside is selected and added to your route. Stop count, crew assignment, and estimated revenue update in real time. Route planning that takes 30 minutes in a spreadsheet takes 5 minutes on the map.'},
            {q:'How does MowBossPro handle recurring visits and rain days?', a:'Set a lawn to weekly, bi-weekly, or any custom cycle and the next visit generates automatically. When weather kills a day, push the whole route forward in one click and every recurring visit shifts cleanly — nothing falls off the schedule.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>MowBossPro runs your full mowing operation — scheduling, dispatch, recurring visits, and billing — all from one platform. <a href="/" style={{color:'var(--orange)', fontWeight:600}}>See the full MowBossPro platform overview</a>.</p>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>MowBossPro is the only mowing management software built by someone who has actually run a mowing route. Try it free for 14 days.</p>
        <div className="hero-btns">
