  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>MowBossPro is built specifically for lawn care and lawn care. Every feature listed here is included in your from $59/month — nothing locked, nothing extra.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="cat-block">
          <div className="cat-header">
            <span className="cat-icon">💰</span>
            <div><div className="cat-title">Estimates</div><div className="cat-desc">Build, send, and close estimates without leaving MowBossPro</div></div>
          </div>
          <div className="feat-grid">
            {[
              ...
              {t:'3-Step Automated Follow-Up',d:"3 follow-up texts go out automatically if a client doesn't respond. MowBossPro chases the deal so you don't have to."},
              {t:'Discount Codes & Sales Tax',d:'Apply percentage or flat discounts. Set tax rates and MowBossPro calculates tax on every estimate automatically.'},
        ...
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'500 Texts/Month Included (US & Canada)',d:'500 texts a month — sent and received — included in the from $59/month. Add more in blocks of 500 for 795 each.'},
      ...
      <style>{`
        .spotlight { background: linear-gradient(135deg, #04162e 0%, #06203f 100%); padding: 90px 40px; }
        ...
        .spotlight-visual { flex: 1; min-width: 280px; background: rgba(255,255,255,.05); border: 2px solid rgba(178,34,52,.35); border-radius: 16px; padding: 32px 28px; }
        ...
        .mock-pin.sel { background: var(--orange); box-shadow: 0 0 0 3px rgba(178,34,52,.3); }
        ...
        .feat-item:hover { border-color: var(--orange); box-shadow: 0 4px 20px rgba(178,34,52,.1); transform: translateY(-2px); }
        ...
        .dark-cat { background: linear-gradient(135deg, #04162e 0%, #06203f 100%); padding: 80px 40px; }
