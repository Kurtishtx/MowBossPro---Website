  ...
  return (
    <>
        ...
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'500 Texts/Month Included (US & Canada)',d:'500 texts a month — sent and received — included in the $79/month. Add more in blocks of 500 for 795 each.'},
      ...
      <div className="cta-band">
        <h2>Every Feature. One Price.<br />$79/Month.</h2>
